...
#ifndef MU_PLAYBACK_REPAIRPANELMODEL_H
#define MU_PLAYBACK_REPAIRPANELMODEL_H
...
class RepairPanelModel : public QAbstractListModel, public muse::async::Asyncable
{
    Q_OBJECT
...
public:
    explicit RepairPanelModel(QObject* parent = nullptr);
...
#endif // MU_PLAYBACK_REPAIRPANELMODEL_H
